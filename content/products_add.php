<?php
/**
 * Логика страницы "Добавление/Изменение товара"
 */
// Изменение товара
...
if (isset($_GET['id'])) {
    ...
    if ($idProduct > 0) {
        ...
        // загрузки кэшированного изображения. Если этого не делать, то после
        // изменения изображения товара при повторной попытке изменения этого
        // же товара будет отображаться старая фотография с тем же названием и
        // тогда помогает только сочетание клавиш "ctrl+f5")
        $timeUploadImg = time();
